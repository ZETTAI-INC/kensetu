    ...
    return (
        <Link href={href} className="group block h-full">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-lg flex flex-col">
                ...
                <h3 className="text-3xl font-black text-text-primary mb-4 font-sans tracking-tight">{title}</h3>
                <p className="text-text-secondary text-lg font-bold leading-relaxed mb-6 flex-grow">
                    {description}
                </p>
                <div className="flex items-center text-primary font-black text-lg group-hover:underline tracking-wide">
