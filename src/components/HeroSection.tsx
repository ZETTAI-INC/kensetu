            ...
            <div className="absolute inset-0 z-20 flex items-end pb-24 md:items-center md:pb-0">
                <div className="w-full max-w-7xl mx-auto px-5 md:px-12">
                    <motion.div
                        ...
                        className="max-w-3xl"
                    >
                        <h1 className="font-bold text-white tracking-wider leading-tight mb-6 md:mb-8">
                            <span className="block text-xs md:text-lg mb-3 md:mb-5 text-white/80 font-medium tracking-[0.2em] md:tracking-[0.25em]">
                                人と企業の成長を支援する
                            </span>
                            <span className="block text-3xl md:text-6xl lg:text-7xl font-black tracking-wide leading-[1.2] md:leading-[1.15]">
                                あなたの可能性を、<br />
                                最大化する。
                            </span>
                        </h1>
                        <p className="text-white/60 text-xs md:text-base font-medium tracking-wider max-w-xl leading-relaxed border-l-2 border-[var(--color-primary)] pl-4 md:pl-5">
